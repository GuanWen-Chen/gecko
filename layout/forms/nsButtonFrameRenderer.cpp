...
LayerState
nsDisplayButtonBoxShadowOuter::GetLayerState(nsDisplayListBuilder* aBuilder,
                                             LayerManager* aManager,
...
nsDisplayButtonBoxShadowOuter::BuildLayer(nsDisplayListBuilder* aBuilder,
                                          LayerManager* aManager,
...
bool
nsDisplayButtonBoxShadowOuter::CreateWebRenderCommands(mozilla::wr::DisplayListBuilder& aBuilder,
                                                       const StackingContextHelper& aSc,
                                                       nsTArray<WebRenderParentCommand>& aParentCommands,
                                                       mozilla::layers::WebRenderLayerManager* aManager,
                                                       nsDisplayListBuilder* aDisplayListBuilder)
{
  ...
  LayoutDeviceRect clipRect = LayoutDeviceRect::FromAppUnits(mVisibleRect, appUnitsPerDevPixel);
