...
#ifndef RenderingContext2D_h
#define RenderingContext2D_h
...
#define NS_RENDERINGCONTEXT2D_IID \
{ 0x993c04c8, 0x8b29, 0x462f, \
 { 0x90, 0xad, 0xbd, 0xe7, 0xfd, 0x99, 0x09, 0x63 } }
...
public:
  ...
  explicit RenderingContext2D(layers::LayersBackend aCompositorBackend);

  virtual JSObject* WrapObject(JSContext *aCx, JS::Handle<JSObject*> aGivenProto) override{return nullptr;};
  ...
  /**
    ...
    * drawn with a filter.
    */
  virtual bool NeedToApplyFilter()
  {
    return false;
  }
  ...
  NS_DECL_CYCLE_COLLECTION_SKIPPABLE_SCRIPT_HOLDER_CLASS(RenderingContext2D)
...
protected:
  ...
  static std::vector<RenderingContext2D*>& DemotableContexts();
  static void DemoteOldestContextIfNecessary();

  static void AddDemotableContext(RenderingContext2D* aContext);
  static void RemoveDemotableContext(RenderingContext2D* aContext);
  ...
  nsTArray<RenderingContext2DUserData*> mUserDatas;
  ...
  virtual bool NeedToCalculateBounds()
  {
    return NeedToDrawShadow();
  }

  virtual mozilla::gfx::CompositionOp UsedOperation()
  {
    if (NeedToDrawShadow()) {
