...
bool
RenderingContext2D::PatternIsOpaque(RenderingContext2D::Style aStyle) const
{
...
{
public:
  typedef RenderingContext2D::Style Style;
  typedef RenderingContext2D::ContextState ContextState;
...
public:
  ...
  DoSourcePaint(gfx::IntRect& aRect, RenderingContext2D::Style aStyle)
  {
    if (aRect.IsEmpty()) {
      return nullptr;
    }
  ...
  ~AdjustedTargetForFilter()
  {
    ...
    RefPtr<SourceSurface> fillPaint =
      DoSourcePaint(mFillPaintRect, RenderingContext2D::Style::FILL);
    RefPtr<SourceSurface> strokePaint =
      DoSourcePaint(mStrokePaintRect, RenderingContext2D::Style::STROKE);
...
RenderingContext2D::CreateDeclaration(nsINode* aNode,
...
bool
RenderingContext2D::PropertyIsInheritOrInitial(Declaration* aDeclaration, const nsCSSPropertyID aProperty)
{
...
RenderingContext2D::GetFontStyleContext(Element* aElement, const nsAString& aFont,
...
void RenderingContext2D::DrawFocusIfNeeded(mozilla::dom::Element& aElement,
                                                 ErrorResult& aRv)
{
  EnsureUserSpacePath();
...
bool RenderingContext2D::DrawCustomFocusRing(mozilla::dom::Element& aElement)
{
  EnsureUserSpacePath();
...
void
RenderingContext2D::SetFont(const nsAString& aFont,
                                  ErrorResult& aError)
{
...
bool
RenderingContext2D::SetFontInternal(const nsAString& aFont,
                                          ErrorResult& aError)
{
  /*
...
void
RenderingContext2D::SetTextAlign(const nsAString& aTextAlign)
{
...
void
RenderingContext2D::GetTextAlign(nsAString& aTextAlign)
{
...
void
RenderingContext2D::SetTextBaseline(const nsAString& aTextBaseline)
{
...
void
RenderingContext2D::GetTextBaseline(nsAString& aTextBaseline)
{
...
void
RenderingContext2D::FillText(const nsAString& aText, double aX,
                                   double aY,
...
void
RenderingContext2D::StrokeText(const nsAString& aText, double aX,
                                     double aY,
                                     const Optional<double>& aMaxWidth,
                                     ErrorResult& aError)
{
...
TextMetrics*
RenderingContext2D::MeasureText(const nsAString& aRawText,
                                      ErrorResult& aError)
{
  float width;
...
struct MOZ_STACK_CLASS CanvasBidiProcessor : public nsBidiPresUtils::BidiProcessor
{
  ...
  virtual void DrawText(nscoord aXOffset, nscoord aWidth)
  {
    ...
    Style style = (mOp == RenderingContext2D::TextDrawOperation::FILL)
                    ? Style::FILL
                    : Style::STROKE;
  ...
  RenderingContext2D::TextDrawOperation mOp;
...
nsresult
RenderingContext2D::DrawOrMeasureText(const nsAString& aRawText,
                                            float aX,
                                            float aY,
                                            const Optional<double>& aMaxWidth,
                                            ...
                                            float* aWidth)
{
  ...
  if (aOp == RenderingContext2D::TextDrawOperation::FILL &&
      !doCalculateBounds) {
...
gfxFontGroup *RenderingContext2D::GetCurrentFontStyle()
{
...
RenderingContext2D::GetImageData(JSContext* aCx, double aSx,
...
nsresult
RenderingContext2D::GetImageDataArray(JSContext* aCx,
                                            int32_t aX,
                                            int32_t aY,
                                            uint32_t aWidth,
                                            uint32_t aHeight,
...
void
RenderingContext2D::PutImageData(ImageData& aImageData, double aDx,
...
nsresult
RenderingContext2D::PutImageData_explicit(int32_t aX, int32_t aY, uint32_t aW, uint32_t aH,
...
already_AddRefed<ImageData>
RenderingContext2D::CreateImageData(JSContext* aCx, double aSw,
                                          double aSh, ErrorResult& aError)
{
  if (!aSw || !aSh) {
    aError.Throw(NS_ERROR_DOM_INDEX_SIZE_ERR);
...
already_AddRefed<ImageData>
RenderingContext2D::CreateImageData(JSContext* aCx,
